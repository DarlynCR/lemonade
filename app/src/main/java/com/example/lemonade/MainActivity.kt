...
class MainActivity : AppCompatActivity() {
    ...
    private fun setViewElements() {
        when(lemonadeState) {
            SELECT -> {
                binding.textAction.text = resources.getString(R.string.lemon_select)
                binding.imageLemonState.setImageResource(R.drawable.lemon_tree)
            }
            SQUEEZE -> {
                binding.textAction.text = resources.getString(R.string.lemon_squeeze)
                binding.imageLemonState.setImageResource(R.drawable.lemon_squeeze)
            }
            DRINK -> {
                binding.textAction.text = resources.getString(R.string.lemon_drink)
                binding.imageLemonState.setImageResource(R.drawable.lemon_drink)
            }

            RESTART -> {
                binding.textAction.text = resources.getString(R.string.lemon_empty_glass)
